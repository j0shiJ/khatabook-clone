                ...
                children: <Widget>[
                  ...
                  SingleChildScrollView(
                    ...
                    child: ListView.builder(
                        itemCount: personalData.persons.length,
                        itemBuilder: (BuildContext context, int index) {
                          return PaymentCard(
                            name: personalData.persons[index].names,
                            time: personalData.persons[index].times,
                            amount: personalData.persons[index].amounts,
                          );
                        }),
                  ),
                  SizedBox(height: 50),
